...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '774805315@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/malcolmlu',
    },
    {
      name: 'Telegram',
